...
const { data: featuredProducts, isLoading } = useQuery({
  ...
  return (
    <div className="min-h-screen">
      <Header />
      {/* Hero Section */}
      <section className="bg-linear-to-r from-pink-600 to-purple-600 text-white py-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {categories.map((category) => (
              <button
                ...
                className="p-6 bg-gray-50 rounded-lg hover:bg-primary-50 hover:border-primary-200 border-2 border-transparent transition-all duration-300 group hover:shadow-md"
              >
